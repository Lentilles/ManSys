...
namespace ManSys.Migrations.ManSysRequest
{
    ...
    [Migration("20230809160741_Initial")]
            ...
            modelBuilder.Entity("ManSys.Models.Request", b =>
                {
                    b.HasOne("ManSys.Models.User", "Creator")
                        .WithOne()
                        .HasForeignKey("ManSys.Models.Request", "CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ManSys.Models.User", "Delivery")
                        .WithOne()
                        .HasForeignKey("ManSys.Models.Request", "DeliveryId");
                    ...
                    b.HasOne("ManSys.Models.User", "Manager")
                        .WithOne()
                        .HasForeignKey("ManSys.Models.Request", "ManagerId");
